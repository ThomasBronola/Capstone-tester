...
<section class="py-5" id="c-it" style="background-color: #343a40;">
   ...
   <!-- SIGN UP MODAL -->
   <div class="modal fade text-center portfolio-modal" role="dialog" tabindex="-1" id="reg-modal" style="margin-top: 40px;border-type:none;">
        <div class="modal-dialog" role="document">
            <div class="modal-content">   
                <div class="container" >
                    <div class="row">
                        ...
                        <div class="col-lg-8 mx-auto">
                            <div class="modal-body">
                                ...
                                <div class="d-inline-block">                                    
                                    ...
                                    <br> <br>
                                    <input type="email" id="proj-id" placeholder="Project ID">
                                    <br><br>                                 
                                    <a class="text-center d-block" id="forgot-password" href="#" style="color:blue;border-color: var(--blue);">&nbsp;Forgot Your Password?</a>                                
                                    <br><br>
